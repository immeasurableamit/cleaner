										...
										return (
											<div className={classNa} key={index}>
												<div className="s_r_msg">
													...
													<div className='attachment_r'>
													{msgs?.files?.length > 0 &&
														msgs.files.map(function (file, i) {
															return (
																<a key={i} className="attachment" target="_blank" href={`uploads/files/${file.name}`}>
																	{file.is_image &&
																		<img height="100" src={`uploads/files/${file.name}`} />
																	}
																	{!file.is_image &&
																		<img height="100" src={`attachment.png`} />
																	}
																</a>
															)
														})
							...
							<div className='message_sender'>
								{filesArray.length > 0 &&
									<div className="attached-files">
										<div className="file files_r" >

											{filesArray.map(function (file, j) {
												return (
													<div className='img_gallery' key={j}>
