                        ...
                        @else
                            ...
                            <div class="action-block">
                                <span class="edit"><a href="javascript::void(0)" class="link-design-2"
                                        wire:click="editData('{{ auth()->user()->id }}', 'contact_number')">Edit</a></span>
                            </div>
                        @endif
                    </div>
                </li>
                <li class="position-relative">
                    <div class="d-flex justify-content-spacebw three_column edit_frm">
                        ...
                        @else
                            ...
                            <div class="action-block">
                                <span class="edit"><a href="javascript::void(0)" class="link-design-2"
                                        wire:click="editData('{{ auth()->user()->id }}', 'email')">Edit</a></span>
                            </div>
                        @endif
                    </div>
                </li>
                    ...
                    <div class="d-flex justify-content-spacebw three_column edit_frm">
                        ...
                        @if (@$fieldStatus == true && $action == 'address')
                            <input id="address_in_banner" type="text" value="{{ $user->UserDetails->address }}"
                                wire:model="address" />
                            <span class="save-icn-btn"><a class="link-design-2" wire:click="updateData('address')"><i
                                        class="fas fa-save"></i></a></span>
                            <span class="cancel"><a href="javascript::void(0)" class="link-design-2"
                                    wire:click="cancle"><i class="fas fa-times"></i></a></span>
                        @else
                            ...
                            <div class="action-block">
                                <span class="edit"><a href="javascript::void(0)" class="link-design-2"
                                        wire:click="editData('{{ auth()->user()->id }}', 'address')">Edit</a></span>
                            </div>
                        @endif
                    </div>
                </li>
                                ...
                                <select wire:model="timezone" id="timezone-offset">
                                    ...
                                    @foreach ($timezones as $timezone)
                                        <option value="{{ $timezone->id }}">
                                            {{ $timezone->name }}{{ $timezone->current_utc_offset }}{{ $timezone->is_currently_dst }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <span class="save-icn-btn"><a class="link-design-2"
                                    wire:click="updateData('timezone')"><i class="fas fa-save"></i></a></span>
                            <span class="cancel"><a href="javascript::void(0)" class="link-design-2"
                                    wire:click="cancle"><i class="fas fa-times"></i></a></span>
                        @else
                            <div class="time-zone-select-design">
                            ...
                            <div class="action-block">
                                <span class="edit"><a href="javascript::void(0)" class="link-design-2"
                                        wire:click="editData('{{ auth()->user()->id }}', 'timezone')">Edit</a></span>
                            </div>
                        @endif
                    </form>
                </li>
                ...
                <li class="position-relative">
                    <div class="d-flex justify-content-spacebw three_column edit_frm">
                        @if (@$fieldStatus == true && $action == 'about')
                            ...
                            <span class="save-icn-btn"><a class="link-design-2" wire:click="updateData('about')"><i
                                        class="fas fa-save"></i></a></span>
                            <span class="cancel"><a href="javascript::void(0)" class="link-design-2"
                                    wire:click="cancle"><i class="fas fa-times"></i></a></span>
                        @else
            ...
            <ul class="list-unstyled">
                    ...
                    <div class="d-flex justify-content-spacebw three_column edit_frm">
                        ...
                        @if (@$fieldStatus == true && $action == 'facebook')
                            ...
                            <span class="cancel"><a href="javascript::void(0)" class="link-design-2"
                                    wire:click="cancle"><i class="fas fa-times"></i></a></span>
                        @else
                            <p class="facebook"><a href="javascript::void(0)">{{ $user->UserDetails->facebook }}</a>
                            </p>
                            <div class="action-block">
                                <span class="edit"><a href="javascript::void(0)" class="link-design-2"
                                        wire:click="editData('{{ auth()->user()->id }}', 'facebook')">Edit</a></span>
                            </div>
                        @endif
                    </div>
                </li>
                    ...
                    <div class="d-flex justify-content-spacebw three_column edit_frm">
                        ...
                        @if (@$fieldStatus == true && $action == 'twitter')
                            ...
                            <span class="cancel"><a href="javascript::void(0)" class="link-design-2"
                                    wire:click="cancle"><i class="fas fa-times"></i></a></span>
                        @else
                            <p class="twitter"><a href="javascript::void(0)">{{ $user->UserDetails->twitter }}</a>
                            </p>
                            <div class="action-block">
                                <span class="edit"><a href="javascript::void(0)" class="link-design-2"
                                        wire:click="editData('{{ auth()->user()->id }}', 'twitter')">Edit</a></span>
                            </div>
                        @endif
                    </div>
                </li>
                ...
                <li class="position-relative">
                    <div class="d-flex justify-content-spacebw three_column edit_frm">
                        ...
                        @else
                            <p class="instagram"><a
                                    href="javascript::void(0)">{{ $user->UserDetails->instagram }}</a></p>
                            <div class="action-block">
                                <span class="edit"><a href="javascript::void(0)" class="link-design-2"
                                        wire:click="editData('{{ auth()->user()->id }}', 'instagram')">Edit</a></span>
                            </div>
                        @endif
                    </div>
                </li>
                    ...
                    <div class="d-flex justify-content-spacebw three_column edit_frm">
                        ...
                        @if (@$fieldStatus == true && $action == 'linkedin')
                            ...
                            <span class="cancel"><a href="javascript::void(0)" class="link-design-2"
                                    wire:click="cancle"><i class="fas fa-times"></i></a></span>
                        @else
                            <p class="linkedin"><a href="javascript::void(0)">{{ $user->UserDetails->linkedin }}</a>
                            </p>
                            <div class="action-block">
                                <span class="edit"><a href="javascript::void(0)" class="link-design-2"
                                        wire:click="editData('{{ auth()->user()->id }}', 'linkedin')">Edit</a></span>
                            </div>
                        @endif
                    </div>
                </li>
