<div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                @endif
                                    ...
                                    @else
                                    <div class="card-edit-content">
                                        <p class="price-area-text"><span class="price_span">${{ $item->cleaner_service->priceForSqFt(1500) }}</span> <span
                                                class="area_span">per 1,500 sq ft</span></p>
                                        <p class="time">{{ $item->cleaner_service->durationForSqFt(1500) }}hrs</p>
                                        <p class="card_toggle_s">Edit</p>
                                    </div>                                
                                    @endif
                                    ...
                                    <div class="card-second-content">
                                        ...
                                        <div class="btn_text">
                                            <p class="text_3">This would equal.... <span class="price">$0</span>
                                                on the
                                    ...
                                    <div class="card-second-content">
                                        <div class="card_row_3">
                                            ...
                                            <div class="incremnt_decrmnt number for_alternative">
                                                <span class="minus">-</span>
                                                <input type="text" value="{{ $item->cleaner_service->price }}" id="price-{{ $item->cleaner_service->id }}"/>
                                                <span class="plus">+</span>
                                            </div>
                                        </div>
                                        <div class="card_row_3">
                                        ...
                                        <div class="btn_text">
                                            <p class="text_3">This would equal.... <span class="price">${{ $item->cleaner_service->priceForSqFt(1500) }}</span>
                                                on the
                                                average <span class="area">1,500 sq</span> ft home</p>
                                            <button class="btn_blue" onclick="updateCleanerService('{{ $item->cleaner_service->id }}')">Save</button>
                                        </div>
                                    </div>
                                    @endif 
                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="card_header_tittle pt-0">
                            <h3 style="color:var(--primary)" class="link-design-2"><svg style="height: 1rem;"
                                    class="svg-inline--fa fa-pen-to-square pe-2" aria-hidden="true"
                        ...
                        <div class="form-grouph textarea-design mb-2">
                            <textarea wire:model="included.4.data"
                                placeholder="Please enter what your services include for the various services offered by you."></textarea>
                        </div>

                        <button class="btn_blue" wire:click="storeIncluded">Save</button>
                        <div class="stng_price">
                            <h3><img
                                    src="https://canarycleaners.smallbizplace.com/assets/images/icons/!!.svg">Setting
                                Prices</h3>
    ...
    <script>
        ...
        function updateCleanerService(cleanerServiceId)
        {
            ...
            @this.call( 'updateCleanerService', cleanerServiceId, { price, duration });
        }
