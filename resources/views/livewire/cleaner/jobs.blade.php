                        ...
                        <div class="row">
                            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link {{ $selectedTab == 1 ? 'active' : '' }}" wire:click="$set('selectedTab', 1 )">My Jobs <svg width="30" height="30" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="service-main-service-column">
                                        <div class="card-layout-showcase">
                                            <div class="job-first-details four-column">
                                                ...
                                                <p class="job-d-info">
                                                    {{ $order->cleaning_datetime->format('h:i A') }}
                                                </p>
                                        ...
                                        <div class="altrntive_rw">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                ...
                                                <li><a href="tel:512-558-5876" class="link-design-2 mt-3"><img src="/assets/images/icons/phone.svg">{{ $order->user->contact_number }}</a>
                                                </li>
