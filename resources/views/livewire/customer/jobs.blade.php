                  ...
                  <div class="customer-account-forms myjob-main-sec">
                    <div class="jobs-section-layout"> 
                      ...
                      <ul class="nav nav-tabs">
                        <li class="nav-item">
                          <a class="nav-link {{ $selectedTab == 1 ? 'active' : '' }}" data-bs-toggle="tab" href="#My-Jobs">My Jobs <svg width="30" height="30" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                          <a class="nav-link {{ $selectedTab == 2 ? 'active' : '' }}"  data-bs-toggle="tab" href="#My-Jobs" >New Requests</a>
                        </li>
                      </ul>
                      </div>
...
<script>
    ...
    window.addEventListener('load', function () {
        ...
        window.livewire.on('renderCalendar', (events) => {
          console.log( events );
