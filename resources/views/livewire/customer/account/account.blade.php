        ...
        <div class="customer-avatar-upload">
            ...
            @if ( $user->image )
                <div id="uploaded" style='background-image: {{ url("/storage/images/$user->image") }}'>
                    ...
                    <a href="javascript::void(0)" onclick="uploadImgViaLivewire('{{ $user->id }}')"  title="Save"><i class="fas fa-save"></i></a>
            ...
            @else
                <div id="uploaded" style="background-image: {{ asset('/assets/images/iconshow.png') }}">
                    ...
                    <a href="javascript::void(0)" onclick="uploadImgViaLivewire('{{ $user->id }}')" title="Save"  title="Save"><i class="fas fa-save"></i></a>
                </div>
            @endif
            </div>
        ...
        <ul class="list-unstyled">
          ...
          {{--  <li class="position-relative">
                <form class="d-flex justify-content-spacebw three_column edit_frm">
                    ...
                    <span class="save-icn-btn"><a class="link-design-2" wire:click="update('timezone')" title="Save"><i class="fas fa-save"></i></a></span>
                    <span class="cancel"><a href="javascript::void(0)" class="link-design-2" wire:click="cancle" title="Close"><i class="fas fa-times"></i></a></span>
                    @else
