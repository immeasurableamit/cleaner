<div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 no-padd">
                ...
                <div id="date_section" class="date_section">
                    ...
                    <div class="card_service_row appoitments-alternative-row row">
                        ...
                        @forelse($selectedDateOrders as $order)
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-2" id="order-{{ $order->id }}">
                                ...
                                <div class="select-date-toggles" wire:ignore.self>
                                    ...
                                    <div class="service-main-service-column">
                                        ...
                                        <div class="altrntive_rw">
                                            ...
                                            <a type="button" class="text-primary bold btn_view_r"
                                        ...
                                        <div class="altrntive_rw">
                                            ...
                                            <div style="margin-right: 5px;" @class([
                                                'text-center',
                                                'align-center',
                                                'complete-status',
                                                'text-danger' =>
                                                ...
                                                'orange_txt' => $order->status == 'pending',
                                                'text-success' =>
                                            ...
                                            @if ($order->status == 'pending')
                                                <a href="javascript::void(0)" class="btn_q"
                                                    wire:click.prevent="showRescheduleModal({{ $order->id }})">Reschedule</a>
                                                ...
                                                <div class="dropdown-header-cntnt">
                                                    <form wire:submit.prevent="storeReview( {{ $order->id }})">
                                                        <div class="star-rating">
                                                            <input type="radio" id="5-stars" wire:model="rating"
                                                                name="rating" value="5">
                                                            ...
                                                            <input type="radio" id="4-stars" wire:model="rating"
                                                                name="rating" value="4">
                                                            <label for="4-stars" class="star"><svg
                                                                ...
                                                                <!-- <i class="far fa-star"></i> Font Awesome fontawesome.com --></label>
                                                            <input type="radio" id="3-stars" wire:model="rating"
                                                                name="rating" value="3">
                                                            <label for="3-stars" class="star"><svg
                                                                ...
                                                                <!-- <i class="far fa-star"></i> Font Awesome fontawesome.com --></label>
                                                            <input type="radio" id="2-stars" wire:model="rating"
                                                                name="rating" value="2">
                                                            <label for="2-stars" class="star"><svg
                                                                ...
                                                                <!-- <i class="far fa-star"></i> Font Awesome fontawesome.com --></label>
                                                            <input type="radio" id="1-star" wire:model="rating"
                                                                name="rating" value="1">
                                                        ...
                                                        @if ($reviewOrderId == $order->id && $errors->has('rating'))
                                                            <div class="text-center">
                                                                <span
                                                                    class="text-danger">{{ $errors->first('rating') }}</span>
                                                            </div>
                                                        @endif
            ...
            <div class="modal-content">
                <div class="modal-header  d-flex justify-content-center">
                    ...
                    <button type="button" class="close btn_close" style="border: none; background: white;top:0px;"
                        wire:click.prevent="hideRescheduleModal">x </button>
                                    ...
                                    <select class="select-custom-design" id="reschedule-time-selector">
                                        ...
                                        @foreach ($rescheduledAvailableTimeSlots as $slot)
                                            ...
                                            <option value="{{ $slot['start_time'] }}" @disabled($slot['is_available'] == false)
                                                @selected($slot['start_time'] == $rescheduleTime) }}>
    ...
    <!-- Modal - View -->
    <div wire:ignore.self class="modal fade modal_style " id="exampleModal2" tabindex="-1"
