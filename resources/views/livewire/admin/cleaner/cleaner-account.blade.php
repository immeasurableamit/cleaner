          ...
          <div class="customer-account-information">
            <ul class="list-unstyled">
              ...
              <li class="position-relative">
                <div class="d-flex ">
                  <h6 class="title-label w-auto"><i class="fas fa-users"></i></h6>
              ...
              <li class="payment-methoud two-blocks d-flex position-relative">
                <div class="payemnt-first-block">
                  <form class="d-flex">
                    <h6 class="title-label w-auto"><svg class="svg-inline--fa fa-credit-card" aria-hidden="true" focusable="false" data-prefix="far" data-icon="credit-card" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
                        <path fill="currentColor" d="M168 336C181.3 336 192 346.7 192 360C192 373.3 181.3 384 168 384H120C106.7 384 96 373.3 96 360C96 346.7 106.7 336 120 336H168zM360 336C373.3 336 384 346.7 384 360C384 373.3 373.3 384 360 384H248C234.7 384 224 373.3 224 360C224 346.7 234.7 336 248 336H360zM512 32C547.3 32 576 60.65 576 96V416C576 451.3 547.3 480 512 480H64C28.65 480 0 451.3 0 416V96C0 60.65 28.65 32 64 32H512zM512 80H64C55.16 80 48 87.16 48 96V128H528V96C528 87.16 520.8 80 512 80zM528 224H48V416C48 424.8 55.16 432 64 432H512C520.8 432 528 424.8 528 416V224z"></path>
              ...
              <li class="position-relative">
                <form class="d-flex">
                  <h6 class="title-label w-auto"><img src="{{ asset('assets/admin/images/icons/tin.svg') }}"></h6>
              ...
              <li class="d-flex position-relative">
                <h6 class="title-label w-auto"><img src="{{ asset('assets/admin/images/icons/team-size.svg') }}"></h6>
                <p>Team Size: 3</p>
              </li>
              <li class="d-flex position-relative">
                <h6 class="title-label w-auto"><img src="{{ asset('assets/admin/images/icons/insured.svg') }}"></h6>
                <p>Insured: Yes</p>
              </li>
