<div class="profile_id">
            ...
            <div class="frst_tm">
                ...
                <div class="folow-us">
                    <ul class="list-unstyled d-flex">
                        ...
                        <li><a target="_blank"
                                href="https://www.facebook.com/sharer/sharer.php?u={{ $socialMediaSharingInfo['url'] }}"><svg
                        ...
                        <li><a target="_blank"
                                href="http://twitter.com/intent/tweet?text={{ $socialMediaSharingInfo['title'] }}&url={{ $socialMediaSharingInfo['url'] }}"><svg
                        ...
                        <li><a target="_blank"
                                href='http://www.linkedin.com/shareArticle?mini=true&url={{ $socialMediaSharingInfo['url'] }}&title={{ $socialMediaSharingInfo['title'] }}'><svg
                                    class="svg-inline--fa fa-linkedin-in" aria-hidden="true" focusable="false"
        ...
        <div class="col-xl-4 col-lg-6 col-md-12 ps-0">
            <div class="secnd_tm">
                ...
                <div class="btn_msg_cleaner">
                    ...
                    @endphp
                    <a href="{{ $messageUrl }}" class="btn_msg">Message Cleaner <img
                                            ...
                                            <optgroup label="{{ $service['title'] }}">
                                                @foreach ($service['serviceItems'] as $serviceItem)
                                                    <option value="{{ $serviceItem['id'] }}"
                                                        @if ($serviceItemId == $serviceItem['id']) selected @endif>
                                                        {{ $serviceItem['title'] }}</option>
                                                @endforeach
                                            </optgroup>
                                        @endforeach
                                        ...
                                        <select id="addon-selector" class="select-custom-design" multiple>
                                            @foreach ($itemAddOns as $addOn)
                                                = <option value="{{ $addOn['id'] }}"
                                                    @if (in_array($addOn['id'], $addOnIds)) selected @endif>
                                                    {{ $addOn['title'] }}</option>
                                            @endforeach
    ...
    @push('scripts')
        ...
        <script>
            ...
            window.livewire.on('componentRendered', () => {
                initSelectors();
            });
