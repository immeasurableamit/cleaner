            ...
            <div class="frst_tm">
                ...
                <div class="folow-us">
                    <ul class="list-unstyled d-flex">
                        ...
                        <li><a target="_blank" href="{{$cleaner->UserDetails->facebook}}"><svg class="svg-inline--fa fa-facebook" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                        ...
                        <li><a target="_blank" href="{{$cleaner->UserDetails->twitter}}"><svg class="svg-inline--fa fa-twitter" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="twitter" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                        ...
                        <li><a target="_blank" href="{{$cleaner->UserDetails->instagram}}"><svg class="svg-inline--fa fa-instagram" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="instagram" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
                        ...
                        <li><a target="_blank" href="{{$cleaner->UserDetails->linkedin}}"><svg class="svg-inline--fa fa-linkedin-in" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin-in" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
        ...
        <div class="col-xl-4 col-lg-6 col-md-12 ps-0">
            <div class="secnd_tm">
                ...
                <div class="btn_msg_cleaner">
                    <a href="message.html" class="btn_msg">Message Cleaner <img src="{{ asset('assets/images/icons/email-2.svg') }}"> </a>
