                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-grouph input-design mb-30">
                                            <input type="text" name="first_name" wire:model="firstname"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-grouph input-design mb-30">
                                            <input type="text" name="last_name" wire:model="lastname"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-grouph input-design mb-30">
                                            <input type="contact" name="contact" wire:model="contact"
                                        ...
                                        <div class="form-grouph mb-30 input-select-abs select_state">
                                            ...
                                            <div class="selecti-box">
                                                <select id="state-selector" name="state"
                                                    class="select-custom-design" id="state-selector">
                                                    <option></option>
                        ...
                        <div class="built_text_div">
                            ...
                            <div class="schedule-block-searccntnt">
                                ...
                                <div class="schduled-text-div">
                                    ...
                                    <span
                                        class="schedule_value-text">{{ $cleanerService->first()->servicesItems->first()->service->title }}</span>
                                </div>
