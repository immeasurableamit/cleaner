        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-grouph input-design mb-30">
                    ...
                    <input type="text" placeholder="Account Holder Name" value="{{ $bank->account_holder_name }}"
            ...
            <div class="col-md-6">
                <div class="form-grouph input-design mb-30">
                    ...
                    <input type="text" placeholder="Confirm Account Number" name="confirm_account_number"
                        value="{{ $bank->account_number }}">
            ...
            @if ($bank->payouts_enabled == 0)
                <div class="col-12 pt-3">
                    <a href="{{ route('cleaner.billing.stripeConnectUpdate') }}" class="btn_blue" role="button"
                        type="button">Update Stripe Account</a>
                </div>
            @endif
        </div>
    </form>
