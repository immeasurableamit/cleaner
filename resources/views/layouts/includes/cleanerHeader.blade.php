                        ...
                        <li class="nav-item signin account-profile">
                            ...
                            <div class="dropdown">
                                <button type="button" class="btn dropdown-toggle position-relative btn-transparent"
                                    data-bs-toggle="dropdown" id="header-profile-dropdown-btn">
                                ...
                                <ul class="dropdown-menu" id="header-profile-dropdown-menu">
                                    <div class="customer_profile-info">
                                        ...
                                        <div class="dropdown-list-design">
                                            <ul class="list-unstyled">
                                                <li class="profile_drop_down account_dropdown">
                                                    <a class="" href="#" class="">Account and Settings
                                                        <img
                                                    ...
                                                    <ul class="dropdown_links">
                                                        ...
                                                        <li><a href="{{ route('cleaner.set-location') }}"
                                                                class="">Set Locations Served</a></li>
                                                ...
                                                <li><a href="{{ route('cleaner.insurance') }}">Insurance and Badges</a>
                                                </li>
                                      ...
                                      document.getElementById('logout-form').submit();">
                                                <img
                                                    src="{{ asset('/assets/images/icons/logout.svg') }}">{{ __('Logout') }}
                                            </a>
