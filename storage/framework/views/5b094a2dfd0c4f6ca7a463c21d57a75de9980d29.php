        ...
        <ul class="list-unstyled">
            ...
            <li class="position-relative">
                <form class="d-flex justify-content-spacebw three_column edit_frm">
                    ...
                    <span style="color:red"> <?php $__errorArgs = ['contact_number'];
...
<?php /**PATH /var/www/html/projects/Amandeep Projects/working project/cleaner/cleaner/resources/views/livewire/customer/account/account.blade.php ENDPATH**/ ?>