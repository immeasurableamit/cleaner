              ...
              <div class="col-md-3">
               <div class="card_questions">
                <img src="assets/images/icons/start_service.svg"/>
                   <a href="<?php echo e(route('terms-and-conditions')); ?>" class="">How do I start service</a>
               </div>
              </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/Amandeep Projects/working project/cleaner/cleaner/resources/views/home/help-center.blade.php ENDPATH**/ ?>