<div class="max_job_time_div border-bottom py-3 ">
  ...
  <form action="<?php echo e(route('cleaner.availability.jobs')); ?>" method="post">
    <?php echo csrf_field(); ?>
...
</div><?php /**PATH /var/www/html/projects/Amandeep Projects/working project/cleaner/cleaner/resources/views/cleaner/availability/jobs.blade.php ENDPATH**/ ?>