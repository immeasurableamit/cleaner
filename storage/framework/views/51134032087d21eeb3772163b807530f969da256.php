                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="banner_text">
                            ...
                            <p>Finally... a place where you can get EXACTLY what you want, at prices you can afford, from people you can trust. Simple. Affordable. Canary Clean. Your schedule, your Canary Cleaner. Canary Clean is the #1 choice for those who know what they want - and for those who don’t!</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-7 p-0">
                        <div class="canary_text">
                            ...
                            <a href="<?php echo e(route('search-result')); ?>" class="btn_c mt-4">Browse Cleaners</a>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="choose_text">
                            <div class="d-none d-md-block">
                                ...
                                <p>Canary Clean was born from the need to provide customers with the best cleaners at the lowest cost, while letting cleaners keep more of what they own too! Its a win-win, and we love that!</p>
                            </div>
                            <div class="choose_list">
                                <div class="card_why">
                                    <img src="assets/images/icons/quick_service.svg">
                                    <h5>Quick service</h5>
                                    <p>All bookings are scheduled in a two-hour window - and many times you may find availability that same day!</p>
                                </div>
                                <div class="card_why">
                                    <img src="assets/images/icons/booking_online.svg">
                                    <h5>Online booking</h5>
                                    <p>Start or stop service. Add a garage to your next cleaning. Change frquency. Pause. Anything you need to do related to cleaning you can do online! </p>
                                </div>
                                <div class="card_why">
                                    <img src="assets/images/icons/trust.svg">
                                    <h5>Cleaners you can trust</h5>
                                    <p>Because we utilize a rating system, you can see a real track record for the cleaner as it relates to cleanings. Only paying customers can rate!</p>
                                </div>
                                <div class="card_why">
                                    <img src="assets/images/icons/support.svg">
                                    <h5>Top-Notch Support</h5>
                                    <p>You can message your Canary Clean team or individual directly! We also offer email support in case any other issues were to arsise - we always will do the right thing!</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
} elseif ($_instance->childHasBeenRendered('uz8wcBD')) {
    $componentId = $_instance->getRenderedChildComponentId('uz8wcBD');
    $componentTag = $_instance->getRenderedChildComponentTagName('uz8wcBD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uz8wcBD');
} else {
    $response = \Livewire\Livewire::mount('home.rated-cleaners');
    $html = $response->html();
    $_instance->logRenderedChild('uz8wcBD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <div class="row">
                <div class="col-md-6 join_us_div">
                    <div class="card_cleaning_join">
                        ...
                        <a href="<?php echo e(route('signup')); ?>" class="btn_c">Join Now</a>
                    </div>
                </div>
                <div class="col-md-6 cleaning_services_div">
                    <div class="card_cleaning_join">
                        ...
                        <a href="<?php echo e(route('search-result')); ?>" class="btn_c">Browse Now</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="clean_house_section">
            <div class="container">
                <div class="text-center mb-5">
                    ...
                    <p class="text-white">...and a cluttered house is a cluttered mind - start your journey to a cleaner home!</p>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cleaner/resources/views/home/index.blade.php ENDPATH**/ ?>