                ...
                <div class="customer-account-forms ">
                    ...
                    <div class="form-headeing-second top_heading feadback_tittle mb-5">
                      ...
                      <div class="stars_top">
                          ...
                          <img src="<?php echo e(asset('assets/images/star.svg')); ?>" />
                          <span>4.5</span>
                      </div>
                    </div>
                    ...
                    <div class="feedback_reviews_section">
                        <div class="card_reviews">
                          <div class="name_img_star">
                            <img src="<?php echo e(asset('assets/images/reviewr_1.png')); ?>" class="pr_img"/>
                           <h5>Jenny Wilson</h5>
                           <div class="star_2">
                             <div class="input_star me-3">
                              ...
                              <img src="<?php echo e(asset('assets/images/star.svg')); ?>">
                              <img src="<?php echo e(asset('assets/images/star.svg')); ?>">
                              <img src="<?php echo e(asset('assets/images/e_star.svg')); ?>">
                             </div>
...
<?php echo $__env->make('layouts.cleanerapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/Amandeep Projects/working project/cleaner/cleaner/resources/views/cleaner/reviews/reviews.blade.php ENDPATH**/ ?>