...
} elseif ($_instance->childHasBeenRendered('y6vUuQE')) {
    $componentId = $_instance->getRenderedChildComponentId('y6vUuQE');
    $componentTag = $_instance->getRenderedChildComponentTagName('y6vUuQE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('y6vUuQE');
} else {
    $response = \Livewire\Livewire::mount('cleaner.support');
    $html = $response->html();
    $_instance->logRenderedChild('y6vUuQE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
			</div>
...
} elseif ($_instance->childHasBeenRendered('38n60jP')) {
    $componentId = $_instance->getRenderedChildComponentId('38n60jP');
    $componentTag = $_instance->getRenderedChildComponentTagName('38n60jP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('38n60jP');
} else {
    $response = \Livewire\Livewire::mount('cleaner.support-contact');
    $html = $response->html();
    $_instance->logRenderedChild('38n60jP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
           </div>
