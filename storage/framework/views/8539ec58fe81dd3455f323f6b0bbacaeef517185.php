...
} elseif ($_instance->childHasBeenRendered('PV2liaE')) {
    $componentId = $_instance->getRenderedChildComponentId('PV2liaE');
    $componentTag = $_instance->getRenderedChildComponentTagName('PV2liaE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PV2liaE');
} else {
    $response = \Livewire\Livewire::mount('admin.cleaner.cleaner');
    $html = $response->html();
    $_instance->logRenderedChild('PV2liaE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
     </div>
...
<?php echo $__env->make('layouts.adminapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cleaner/resources/views/admin/cleaner/cleaner.blade.php ENDPATH**/ ?>