                      ...
                      <ul class="list-unstyled">
                        <li class="profile_drop_down account_dropdown">
                          ...
                          <ul class="dropdown_links">
                            ...
                            <li><a href="<?php echo e(route('cleaner.availability.index')); ?>" class="">Set Availability</a></li>
                            <li><a href="<?php echo e(route('cleaner.services.index')); ?>" class="">Set Services</a></li>
                            <li><a href="cleaner-set-location.html" class="">Set Locations Served</a></li>
                            <li><a href="<?php echo e(route('cleaner.notification.index')); ?>" class="">Notification Preferences</a></li>
                        ...
                        <li><a href="<?php echo e(route('cleaner.support.service')); ?>">Support</a></li>
                      </ul>
                    </div>
...
</header><?php /**PATH /var/www/html/projects/Amandeep Projects/working project/cleaner/cleaner/resources/views/layouts/includes/cleanerHeader.blade.php ENDPATH**/ ?>