...
} elseif ($_instance->childHasBeenRendered('0yT11tl')) {
    $componentId = $_instance->getRenderedChildComponentId('0yT11tl');
    $componentTag = $_instance->getRenderedChildComponentTagName('0yT11tl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0yT11tl');
} else {
    $response = \Livewire\Livewire::mount('cleaner.team');
    $html = $response->html();
    $_instance->logRenderedChild('0yT11tl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
          </div>
...
<?php echo $__env->make('layouts.cleanerapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/Amandeep Projects/working project/cleaner/cleaner/resources/views/cleaner/team.blade.php ENDPATH**/ ?>