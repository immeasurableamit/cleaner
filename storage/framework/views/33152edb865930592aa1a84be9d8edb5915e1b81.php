...
} elseif ($_instance->childHasBeenRendered('a2cRO6d')) {
    $componentId = $_instance->getRenderedChildComponentId('a2cRO6d');
    $componentTag = $_instance->getRenderedChildComponentTagName('a2cRO6d');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('a2cRO6d');
} else {
    $response = \Livewire\Livewire::mount('cleaner.support');
    $html = $response->html();
    $_instance->logRenderedChild('a2cRO6d', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
			</div>
...
} elseif ($_instance->childHasBeenRendered('uiO2KCo')) {
    $componentId = $_instance->getRenderedChildComponentId('uiO2KCo');
    $componentTag = $_instance->getRenderedChildComponentTagName('uiO2KCo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uiO2KCo');
} else {
    $response = \Livewire\Livewire::mount('cleaner.support-contact');
    $html = $response->html();
    $_instance->logRenderedChild('uiO2KCo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
           </div>
