...
} elseif ($_instance->childHasBeenRendered('6T8xTcX')) {
    $componentId = $_instance->getRenderedChildComponentId('6T8xTcX');
    $componentTag = $_instance->getRenderedChildComponentTagName('6T8xTcX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6T8xTcX');
} else {
    $response = \Livewire\Livewire::mount('home.profile');
    $html = $response->html();
    $_instance->logRenderedChild('6T8xTcX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/projects/Amandeep Projects/working project/cleaner/cleaner/resources/views/home/profile.blade.php ENDPATH**/ ?>